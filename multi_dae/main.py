...
def parse_args():
    ...
    parser.add_argument('-mn', '--model_name', type=str, default='multi_dae', help='Model name')
    ...
    parser.add_argument('--enc_module_name', type=str, nargs='+', default=['layers.0.weight'], help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, nargs='+', default=['layers.3.weight', 'layers.3.bias'], help='Name of decoder module to protect')
