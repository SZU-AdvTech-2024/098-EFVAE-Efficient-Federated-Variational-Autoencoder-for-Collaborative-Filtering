...
def parse_args():
    ...
    parser.add_argument('-mn', '--model_name', type=str, default='ef-recvae', help='Model name')
    parser.add_argument('-dn', '--dataset_name', type=str, default='ml-1m', help='Dataset')  # lastfm, citeulike-a, filmtrust, steam
    parser.add_argument('-ln', '--logger_name', type=str, default='[test]', help='Logger name')
    ...
    parser.add_argument('-ns', '--num_sample', type=int, default=200, help='Number of negative samples')
    ...
    parser.add_argument('--enc_module_name', type=str, nargs='+', default=['encoder.enc_embeddings.weight'], help='Name of encoder module to protect')
