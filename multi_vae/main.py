...
def parse_args():
    ...
    parser.add_argument('-mn', '--model_name', type=str, default='multi_vae', help='Model name')
    ...
    parser.add_argument('--enc_module_name', type=str, nargs='+', default=['q_layers.0.weight'], help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, nargs='+', default=['p_layers.1.weight', 'p_layers.1.bias'], help='Name of decoder module to protect')
