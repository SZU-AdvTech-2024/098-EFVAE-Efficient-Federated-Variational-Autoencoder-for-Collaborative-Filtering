...
def parse_args():
    ...
    parser.add_argument('-mn', '--model_name', type=str, default='ef-multi_vae', help='Model name')
    ...
    parser.add_argument('--anneal_cap', type=float, default=0.2, help='The hyper parameter of the weight of KL loss')
    parser.add_argument('--total_anneal_steps', type=int, default=200000, help='The maximum steps of anneal update')
    
    # sampler setting
    parser.add_argument('-sn', '--sampler_name', type=str, default='FIMS-Uni', help='Sampler name')  # Uni, Pop, FIMS-Uni, FIMS-Pop
    parser.add_argument('-ns', '--num_sample', type=int, default=800, help='Number of negative samples')
    parser.add_argument('-nc', '--num_cluster', type=int, default=16, help='Number of cluster')
    parser.add_argument('-pcm', '--pop_count_mode', type=int, default=2, help='Mode of popularity')
    ...
    parser.add_argument('--enc_module_name', type=str, nargs='+', default=['enc_embeddings.weight'], help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, nargs='+', default=['dec_embeddings.weight', 'dec_bias.weight'], help='Name of decoder module to protect')
