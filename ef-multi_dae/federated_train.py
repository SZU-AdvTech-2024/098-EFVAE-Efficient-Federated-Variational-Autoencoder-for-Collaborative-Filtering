...
from model.ef_multi_dae import EFMultiDAE
...
class Clients:
    def __init__(self, args, dataset):
        ...
        self.model = EFMultiDAE(args, dataset)
    ...
    def train(self, uids: torch.Tensor, model_param_state_dict: dict, sampler: SamplerBase) -> dict:
        ...
        for uid in uids:
            ...
            loss, sampling_items = self.model.calculate_loss(pos_items, sampler)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for uids in uid_seq:
                ...
                clients_grads = self.clients.train(uids, self.model.state_dict(), self.sampler)
