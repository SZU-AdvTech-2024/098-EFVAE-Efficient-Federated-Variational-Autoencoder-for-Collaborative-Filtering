    ...
    def __iter__(self):
        ...
        for _, start_idx in enumerate(range(0, n, self.batch_size)):
            ...
            if self.sparse_data_te is not None:
                data_te_tr = torch.FloatTensor(self.sparse_data_te[0][idxlist[start_idx:end_idx]].toarray())
                data_te_te = torch.FloatTensor(self.sparse_data_te[1][idxlist[start_idx:end_idx]].toarray())
                data_te = (data_te_tr, data_te_te)
